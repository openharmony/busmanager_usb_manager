...
const std::string SYS_APP_PERMISSION_DENIED_SYSAPI = "SYS_APP_PERMISSION_DENIED_SYSAPI";
...
enum UsbErrCode {
    ...
    UEC_SERVICE_FUNCTION_NOT_SUPPORT,
    UEC_SERVICE_PERMISSION_DENIED_SYSAPI_FAILED,
    UEC_SERIAL_PORT_REPEAT_OPEN,
    UEC_SERIAL_PORT_REPEAT_CLOSE,
    UEC_SERIAL_PORT_NOT_OPEN,
    UEC_SERIAL_IO_EXCEPTION,
    UEC_SERIAL_DEVICENOTOPEN,
    UEC_SERIAL_OTHER_ERROR,
    UEC_SERIAL_PORT_NOT_EXIST,
    UEC_SERIAL_PORT_OCCUPIED,
    UEC_SERIAL_DATEBASE_ERROR,
    UEC_INTERFACE_BUSY,
    UEC_SERVICE_IO_EXCEPTION,
};
